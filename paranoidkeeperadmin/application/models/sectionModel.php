...
class sectionModel extends CI_Model {
    ...
    /**
     * This funtion inserts a history 
     * @returns an array 
     */
    public function setUserHistory($data) {
        $this->db->insert('history', $data);
    }

    /**
     * This funtion obtain a history 
     * @returns an array 
     */
    ...
    public function signIn($mail) {
        ...
        if (isset($user['0'])) {
            ...
            $data = array(
                ...
                'type' => 1,
                'user_id' => $user['0']['id'],
                'start_connection'=>date("Y-m-d H:i:s"),
            );
    ...
    /**
     * Changes the password to a null value
    ...
    public function signOut() {
        try {
            ...
            $this->db->update('token', array("type" => 0,'end_connection'=>date("Y-m-d H:i:s")));
