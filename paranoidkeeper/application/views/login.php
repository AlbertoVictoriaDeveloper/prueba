        ...
        <div>
            ...
            <div class="login_wrapper">
				...
				<br>
                    ...
                    <span > <img SRC="<?= base_url() ?>img/horizontal.png"  ALT="ParanoidKeeper" WIDTH=200 HEIGHT=85></span>
                        ...
                        <div class="separator">
                            <div id="registry" name="registry">   
                                <a  onclick="registerMail()" id="resgister" name="register">Register</a> 
                            </div> 
    ...
    <div id='sendpass' style='padding:10px; background:#fff;'>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
				  ...
				  <div class="x_title">
					...
					<span><h5>Your login information session was sent to your e-mail</h5></span>
                    <center>
